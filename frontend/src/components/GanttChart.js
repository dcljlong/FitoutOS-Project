    ...
    tasks.forEach(task => {
      if (task.planned_start && task.planned_finish) {
        allItems.push({
          ...
          required_crew_standard: task.required_crew_standard,
          required_crew_with_saturday: task.required_crew_with_saturday,
          duration_days_at_standard_crew: task.duration_days_at_standard_crew,
          duration_gap_days_at_standard_crew: task.duration_gap_days_at_standard_crew,
          extra_crew_needed_standard: task.extra_crew_needed_standard,
          recommended_recovery_crew: task.recommended_recovery_crew,
          recovery_strategy: task.recovery_strategy,
          programme_feasible: task.programme_feasible,
